        ...
        for (let i = 0; i < pollution.length; i++) {
            for (let j = 0; j < compareTabs.length; j++) {
                ...
                if (String(i + 1) == compIndex) {
                    ...
                    finalPoll[i] = { ...finalPoll[i], [Object.keys(compIndex)[0].replace(`${compIndex}_`, '')]: Object.values(pollution[i])[0] }
                }
            }
        }
